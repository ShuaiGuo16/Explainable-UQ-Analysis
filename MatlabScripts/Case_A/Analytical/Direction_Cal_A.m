function [ a_omega_value, b_omega_value ] = Direction_Cal_A( freq, growth )
...
a_omega_value = double(subs(subs(a_omega,freq,434.2*2*pi),growth,-4));
b_omega_value = double(subs(subs(b_omega,freq,434.2*2*pi),growth,-4));
