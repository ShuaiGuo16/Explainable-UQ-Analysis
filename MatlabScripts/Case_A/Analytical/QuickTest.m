...
a_omega_value = double(subs(subs(a_omega,freq,438.2*2*pi),growth,-4))
b_omega_value = double(subs(subs(b_omega,freq,438.2*2*pi),growth,-4))

[ a, b ] = Direction_Cal_A( 434.2*2*pi, -4 )