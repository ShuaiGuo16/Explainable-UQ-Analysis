...
plot([0,FTF_total_ref(1)],[0,FTF_total_ref(2)],'-r','LineWidth',0.8)
% quiver(0,0,FTF_total_ref(1),FTF_total_ref(2),'AutoScale','off','Color','r')
...
% print('ISOLine-CaseB','-dtiff','-r600')