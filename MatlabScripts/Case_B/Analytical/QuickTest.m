...
a_value = double(subs(subs(real(H_subs),freq,612.6749),growth,-3.9844))
b_value = double(subs(subs(imag(H_subs),freq,612.6749),growth,-3.9844))
% a_omega = diff(real(H_subs),growth);
% b_omega = diff(imag(H_subs),freq);
% a_omega_value = double(subs(subs(a_omega,freq,97.46*2*pi),growth,-4))
% b_omega_value = double(subs(subs(b_omega,freq,97.46*2*pi),growth,-4))
